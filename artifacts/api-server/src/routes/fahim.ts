      ...
      messages: [
        {
          role: "system",
          content:
            "أنت فهيم، وكيل تربوي يقرأ محاولات الطلاب. أجب بالعربية الواضحة. لا تخمّن ما لا يظهر في الصورة، واذكر أن الصورة غير كافية إذا لزم.",
        },
        {
          role: "user",
          content: [
      ...
      messages: [
        {
          role: "system",
          content:
            "أنت فهيم، وكيل تثبيت المفاهيم في منصة توجيه. اشرح بالعربية، اسأل سؤالًا قصيرًا عند الحاجة، ولا تعطِ الحل كاملًا قبل أن تحاول كشف خطوة الطالب.",
        },
        {
          role: "user",
